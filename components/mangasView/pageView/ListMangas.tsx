      ...
      <div className="text-center mb-10">
        ...
        {pagination && (
          <div className="text-xs text-gray-500 mb-4 p-2 bg-gray-900 rounded">
            Debug: Current Page: {effectiveCurrentPage} | URL Page:{" "}
            {currentPage} | Total Pages: {pagination.last_visible_page} | Has
            Next: {pagination.has_next_page.toString()} | Total Items:{" "}
            {pagination.items?.total || "N/A"} | Search Key: {searchKey}
          </div>
        )}
